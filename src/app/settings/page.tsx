        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <InputField
              ...
              placeholder="Ayush Rai Design Studio"
            />
            <InputField
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <InputField
              ...
              onChange={(v) => handleChange("bank_account_name", v)}
              placeholder="Ayush Rai"
            />
            <div className="grid grid-cols-2 gap-4">
              <InputField
                ...
                placeholder="XXXXXXXXXX4821"
              />
              <InputField
                label="IFSC Code"
                value={formData.bank_ifsc}
                onChange={(v) => handleChange("bank_ifsc", v)}
            ...
            <InputField
              ...
              onChange={(v) => handleChange("upi_id", v)}
              placeholder="ayush@upi"
            />
            <InputField
              label="Default Payment Terms"
              value={formData.default_payment_terms}
              onChange={(v) => handleChange("default_payment_terms", v)}
